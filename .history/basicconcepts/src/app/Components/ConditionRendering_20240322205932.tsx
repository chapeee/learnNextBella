...
export default function ConditionRendering() {
    ...
    const [numberEvenOrOdd, setnumberEvenOrOdd] = useState<number>(3) // update this number to anything and check the output
            ...
            <div className="mt-5">
                {
                    ...
                    isEvenNumber ? (
                        <div className='text-sucess text-2xl'>Yes {numberEvenOrOdd}, am even number</div>
                    ) : (
                        <div className='text-danger text-2xl'>So sad {numberEvenOrOdd}, am not even number</div>
                    )
